		...
		struct tee_ioctl_buf_data __user *ubuf)
{
	...
	uarg = (struct tee_ioctl_open_session_arg __user *)(long)buf.buf_ptr;
		...
		struct tee_ioctl_buf_data __user *ubuf)
{
	...
	uarg = (struct tee_ioctl_invoke_arg __user *)(long)buf.buf_ptr;
		...
		struct tee_ioctl_buf_data __user *ubuf)
{
	...
	uarg = (struct tee_iocl_supp_recv_arg __user *)(long)buf.buf_ptr;
		...
		struct tee_ioctl_buf_data __user *ubuf)
{
	...
	uarg = (struct tee_iocl_supp_send_arg __user *)(long)buf.buf_ptr;
